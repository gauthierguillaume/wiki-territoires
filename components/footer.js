            ...
            <ul className='footer__social'>
              <li>
                <a href='https://twitter.com/etalab' title='Twitter'>
                  <img src='/static/images/medias/twitter.svg' className='icon' />
                </a>
              </li>
              <li>
                <a href='https://github.com/etalab' title='Github'>
                  <img src='/static/images/medias/github.svg' className='icon' />
                </a>
              </li>
              <li>
                <a href='https://www.facebook.com/etalab' title='Facebook'>
                  <img src='/static/images/medias/facebook.svg' className='icon' />
                </a>
              </li>
              <li>
                <a href='mailto:info@data.gouv.fr' title='Nous écrire un mail'>
                  <img src='/static/images/medias/envelop.svg' className='icon' />
                </a>
              </li>
            </ul>
          </div>
